...
| Module                    | Description                                                                                                                                                                                                     |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `recovery_callbacks.py`   | Thin dispatcher (Round 5 F3, ~80 LOC): `_dispatch`, `handle_recovery_callback`, `_validate_recovery_state`, `_clear_recovery_state` — routes recovery callback prefixes to `recovery_banner` or `resume_picker` |
